...
public enum ErrorCode{
  ...
  * */
  ...
  MEMBER_PASSWORD_INCORRECT(HttpStatus.UNAUTHORIZED, "비밀번호가 틀립니다."),
  PASSWORD_CHECK_INCORRECT(HttpStatus.BAD_REQUEST, "비밀번호 확인이 일치하지 않습니다."),
  ACCOUNT_NAME_ALREADY_EXISTS(HttpStatus.CONFLICT, "이미 존재하는 계정 명 입니다."),
  ...
  COMMENT_DELETE_NO_AUTHORITY(HttpStatus.FORBIDDEN, "댓글 삭제 권한이 없습니다."),
  COMMENT_UPDATE_NO_AUTHORITY(HttpStatus.FORBIDDEN, "댓글 수정 권한이 없습니다."),
  ...
  LOGIN_FAILED_PASSWORD_INCORRECT(HttpStatus.UNAUTHORIZED, "로그인에 실패하였습니다. 비밀번호가 틀립니다."),
